...
contract('TokenAirdrop', ([admin, signer, _]) => {
  ...
  const createSignature = params => {
    ...
    const privKey = '07289ef70f1700cde36dd3ac04722ac9262115ce7435b62e39122a773fa8aa4d';
  ...
  it('Sample message', async() =>{
    const va= {recipient: "0xe6fDef5b2C067ebEB01DdEe75c270c61Bd21b7B8", amount:"1000000000000000000"}
    const message = web3.utils.soliditySha3(
